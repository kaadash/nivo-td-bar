 ...
 * @returns {Function}
 */
var getGroupedScale = exports.getGroupedScale = function getGroupedScale(data, keys, _minValue, _maxValue, range, edge) {
...
var generateVerticalGroupedBars = exports.generateVerticalGroupedBars = function generateVerticalGroupedBars(_ref) {
    ...
    if (barWidth > 0) {
        keys.forEach(function (key, i) {
            (0, _lodash.range)(xScale.domain().length).forEach(function (index) {
 ...
 * @return {{ xScale: Function, yScale: Function, bars: Array.<Object> }}
 */
var generateHorizontalGroupedBars = exports.generateHorizontalGroupedBars = function generateHorizontalGroupedBars(_ref3) {
    var data = _ref3.data,
    ...
    if (barHeight > 0) {
        keys.forEach(function (key, i) {
            (0, _lodash.range)(yScale.domain().length).forEach(function (index) {
